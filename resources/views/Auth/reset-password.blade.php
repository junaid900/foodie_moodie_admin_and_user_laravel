...
<body id="register_bg" >
	<div id="register">
		<aside>
			...
			<form autocomplete="off" action="{{route('user.reset-password')}}" method="POST">
                @csrf
				...
				<div class="form-group">
					<input class="form-control" type="email" placeholder="Email" name="email"  value="{{$email->email??''}}">
				...
				<div class="form-group">
					<input class="form-control" type="password" id="cofirm-password" placeholder="confirm Password" name="password_confirmation" value="">

					<i class="icon_lock_alt"></i>
				</div>
			
			
				<button class="btn_1 gradient full-width" type="submitt" id="loginButton">Submit</button>

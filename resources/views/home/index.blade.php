                                ...
                                <div class="row g-0 custom-search-input ">
                                    <div class="col-lg-10">
                                        <div class="form-group">
                                            <input class="form-control no_border_r" type="text" id="homeAddressautocomplete"
                                                placeholder="Address, neighborhood...">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        {{-- <button class="btn_1 gradient" type="submit">Search</button> --}}
                                        <a class="btn_1 gradient py-lg-3"
                                            href="{{ route('user.home.restaurants') }}">Search</a>
                    ...
                    <a href="{{ route('user.home.restaurants.category_wise', $data['id']) }}">
                        <figure>
                            ...
                            <img src="{{ asset('storage/app/public/category') }}/{{ $data['image'] }}"
                                ...
                                onerror="this.src='{{ asset('public/home_assets/img/cat_listing_placeholder.png') }}'">
                            <div class="info">
                                <h3>{{ $data['name'] }}</h3>
                ...
                <div class="container margin_60_0">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box_how">
                                <figure><img
                                        src="{{ asset('public/home_assets/img/lazy-placeholder-100-100-white.png') }}"
                                        data-src="{{ asset('public/home_assets/img/how_1.svg') }}" alt=""
                        ...
                        <div class="col-md-4">
                            <div class="box_how">
                                <figure><img
                                        src="{{ asset('public/home_assets/img/lazy-placeholder-100-100-white.png') }}"
                                        data-src="{{ asset('public/home_assets/img/how_2.svg') }}" alt=""
                                        width="130" height="167" class="lazy"></figure>
                        ...
                        <div class="col-md-4">
                            <div class="box_how">
                                <figure><img
                                        src="{{ asset('public/home_assets/img/lazy-placeholder-100-100-white.png') }}"
                                        data-src="{{ asset('public/home_assets/img/how_3.svg') }}" alt=""
                                        width="150" height="167" class="lazy"></figure>
                                <h3>Enjoy Food</h3>
                        ...
                        <div class="col-lg-8  align-self-center">
                            <div class="intro_txt">
                                ...
                                <p class="lead">
                                    Start ordering now to get amazing deals!<br>
                                    We have a wide range of products to choose from.<br>
                                    Explore our best sellers and find what you need at great prices.<br>
                                ...
                                @endphp
                            @if(!$isLoggedIn)
                                <p><a href="{{route('user.register')}}" class="btn_1 medium gradient pulse_bt mt-2">Register</a></p>
                            @endif
                            </div>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#popularFood .owl-carousel').owlCarousel({
                        ...
                        responsive: {
                            992: {
                              items: 3 // Show 3 items on screens wider than 768px
                            },
                            400: {
                              items: 2 // Show 4 items on screens wider than 992px
                            },
                            300: {
                              items: 1 // Show 4 items on screens wider than 992px
                            }

...
@section('scripts')
    ...
    const database = getDatabase(app);
     ...
     function updateOrderCountBadge(orderId) {
    var countRef = ref(database, 'orders/' + orderId + '/chats/counts');
        ...
        onValue(countRef, (snapshot) => {
            ...
            var  cr_count = (countData && countData[ 'cr_count'] && countData[ 'cr_count'].for == 'customer') ? countData[ 'cr_count'].count : 0;
            var  cv_count = (countData && countData[ 'cv_count'] && countData[ 'cv_count'].for == 'customer') ? countData[ 'cv_count'].count : 0;
            
            var count = cr_count + cv_count;
             // Update the badge
            var badgeElement = document.getElementById('badge-chat-' + orderId);
        ...
        $(document).ready(function() {
            ...
            console.log('MK: in running orders');
                    ...
                    success: function(data) {
                        ...
                        $.each(data.response.orders, function(index, order) {
                          ...
                          <tr>
                                ...
                                <td><a class="btn text-success" href="{{ url('user/order/detail/')}}/${order.id}" ><i class="fa-regular fa-eye"></i></a>
                                <span id="badge-chat-${order.id}" class="badge badge-danger"></span>
                                </td>
                                
                                </tr>`;
                                
                                updateOrderCountBadge(order.id);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                      ...
                      <tr>
                            ...
                            <td><a class="btn text-success" href="{{ url('user/order/detail/')}}/${past_order.id}" ><i class="fa-regular fa-eye"></i></a></td>

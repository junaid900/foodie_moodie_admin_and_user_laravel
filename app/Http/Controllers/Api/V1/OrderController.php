...
class OrderController extends Controller
{
        ...
        if ($restaurant->minimum_order > $product_price + $total_addon_price + $deal_price) {
            ...
            return _response(0, translate('messages.failed'), [
                'errors' => [
                    ...
                    'cause' => $product_price + $total_addon_price + $deal_price
                    ]
                ]
            ], 406);
            // return response()->json([
    ...
    public function cancel_order(Request $request)
    {
        ...
        if(!$order){
            ...
            // return _response(0,"Order cancelled successfully.", 200);
    ...
    public function change_order_status(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            'order_id' => 'required',
            'status' => 'required|in:rider_accepted,arrived_at_vendor,picked_up,arrived_at_customer,delivered,disputed,confirmed','handover'
        ]);

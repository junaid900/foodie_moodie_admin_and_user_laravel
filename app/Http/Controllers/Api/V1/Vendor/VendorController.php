...
class VendorController extends Controller
{
    ...
    public function get_order_details(Request $request)
    {
        ...
        $order['order_ratings'] = DB::table('order_reviews')->where('order_id',$order->id)->first();
        $order['rider_ratings'] = DB::table('d_m_reviews')->where('order_id',$order->id)->first();
        $order['order_reports'] = DB::table('order_reports')->where('order_id',$order->id)->get();

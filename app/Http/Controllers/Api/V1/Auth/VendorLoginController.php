...
class VendorLoginController extends Controller
{
    ...
    public function login_gmail(Request $request)
    {
        ...
        $data = [
            ...
            $vendor->save();
            if($vendor){
                return _response(1,"Login Successful!",["code"=>"success",'token' => $token]);
            }else{
                return _response(1,"Login Failed!",["code"=>"failed","message"=>"You are not registered as vendor."]);
            }

...
Route::get('/admin/jazzcash/calculate', 'JazzcashController@calculate_total');
...
Route::group(['prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::get('google-login', [LoginController::class, 'google_login'])->name('google_login');
    Route::get('google_callback', [LoginController::class, 'google_callback'])->name('google_callback');
    ...
    Route::post('forgot-password', [LoginController::class, 'sendForgotLink'])->name('send-email');
    Route::get('password/reset/{token}', [LoginController::class, 'showResetForm'])->name('show-reset-form');
    Route::post('password/reset', [LoginController::class, 'reset'])->name('reset-password');
    ...
    Route::middleware([alreadyLoggedIn::class])->group(function () {
        ...
        Route::get('favorites', [UserRestaurentController::class, 'favorites'])->name('home.favorites');
        Route::post('favorite/{restaurant}', [UserRestaurentController::class, 'toggleFavorite'])->name('restaurant.favorite');
...
Route::get('view/login', 'Auth\GoogleController@login');
